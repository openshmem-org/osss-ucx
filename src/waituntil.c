...
#define SHMEM_TYPE_WAIT_UNTIL(_opname, _type, _size)                    \
    ...
    {                                                                   \
        switch (cmp) {                                                  \
        case SHMEM_CMP_EQ:                                              \
            shmemc_wait_eq_until##_size((int##_size##_t *) ivar, cmp_value); \
            break;                                                      \
        case SHMEM_CMP_NE:                                              \
            shmemc_wait_ne_until##_size((int##_size##_t *) ivar, cmp_value); \
            break;                                                      \
        case SHMEM_CMP_GT:                                              \
            shmemc_wait_gt_until##_size((int##_size##_t *) ivar, cmp_value); \
            break;                                                      \
        case SHMEM_CMP_LE:                                              \
            shmemc_wait_le_until##_size((int##_size##_t *) ivar, cmp_value); \
            break;                                                      \
        case SHMEM_CMP_LT:                                              \
            shmemc_wait_lt_until##_size((int##_size##_t *) ivar, cmp_value); \
            break;                                                      \
        case SHMEM_CMP_GE:                                              \
            shmemc_wait_ge_until##_size((int##_size##_t *) ivar, cmp_value); \
            break;                                                      \
        default:                                                        \
            logger(LOG_FATAL,                                           \
