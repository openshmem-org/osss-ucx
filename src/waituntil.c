...
#define SHMEM_TYPE_WAIT_UNTIL(_name, _type)                             \
    void                                                                \
    shmem_##_name##_wait_until(_type *ivar, int cmp, _type cmp_value)   \
    {                                                                   \
        switch (cmp) {                                                  \
        case SHMEM_CMP_EQ:                                              \
            shmemc_##_name##_wait_eq_until(ivar, cmp_value);            \
            break;                                                      \
        case SHMEM_CMP_NE:                                              \
            shmemc_##_name##_wait_ne_until(ivar, cmp_value);            \
            break;                                                      \
        case SHMEM_CMP_GT:                                              \
            shmemc_##_name##_wait_gt_until(ivar, cmp_value);            \
            break;                                                      \
        case SHMEM_CMP_LE:                                              \
            shmemc_##_name##_wait_le_until(ivar, cmp_value);            \
            break;                                                      \
        case SHMEM_CMP_LT:                                              \
            shmemc_##_name##_wait_lt_until(ivar, cmp_value);            \
            break;                                                      \
        case SHMEM_CMP_GE:                                              \
            shmemc_##_name##_wait_ge_until(ivar, cmp_value);            \
            break;                                                      \
        default:                                                        \
            logger(LOG_FATAL,                                           \
