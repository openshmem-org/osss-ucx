 ...
 */
void
shmemc_mem_init(void *base, size_t capacity)
{
 ...
 */
void *
shmemc_mem_realloc(void *addr, size_t new_size)
{
 ...
 */
void *
shmemc_mem_align(size_t alignment, size_t size)
{
