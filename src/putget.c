...
SHMEM_CTX_SIZED_PUT(8, 1)
SHMEM_CTX_SIZED_PUT(16, 2)
SHMEM_CTX_SIZED_PUT(32, 4)
SHMEM_CTX_SIZED_PUT(64, 8)
SHMEM_CTX_SIZED_PUT(128, 16)
...
SHMEM_CTX_SIZED_IPUT(8, 1)
SHMEM_CTX_SIZED_IPUT(16, 2)
SHMEM_CTX_SIZED_IPUT(32, 4)
SHMEM_CTX_SIZED_IPUT(64, 8)
SHMEM_CTX_SIZED_IPUT(128, 16)
...
SHMEM_CTX_SIZED_PUT_NBI(8, 1)
SHMEM_CTX_SIZED_PUT_NBI(16, 2)
SHMEM_CTX_SIZED_PUT_NBI(32, 4)
SHMEM_CTX_SIZED_PUT_NBI(64, 8)
SHMEM_CTX_SIZED_PUT_NBI(128, 16)
...
SHMEM_CTX_SIZED_GET(8, 1)
SHMEM_CTX_SIZED_GET(16, 2)
SHMEM_CTX_SIZED_GET(32, 4)
SHMEM_CTX_SIZED_GET(64, 8)
SHMEM_CTX_SIZED_GET(128, 16)
...
SHMEM_CTX_SIZED_IGET(8, 1)
SHMEM_CTX_SIZED_IGET(16, 2)
SHMEM_CTX_SIZED_IGET(32, 4)
SHMEM_CTX_SIZED_IGET(64, 8)
SHMEM_CTX_SIZED_IGET(128, 16)
...
SHMEM_CTX_SIZED_GET_NBI(8, 1)
SHMEM_CTX_SIZED_GET_NBI(16, 2)
SHMEM_CTX_SIZED_GET_NBI(32, 4)
SHMEM_CTX_SIZED_GET_NBI(64, 8)
SHMEM_CTX_SIZED_GET_NBI(128, 16)
