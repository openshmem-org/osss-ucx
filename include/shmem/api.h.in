...
#define API_ALLTOALLS_SIZE(_size)                                       \
    ...
    /**
     * Possibly-contexts-based generics
     *
     */

    /* see \ref shmem_long_put() */
#define shmem_put(arg1, arg2, ...)                                  \
    _Generic((arg1),                                                \
             shmem_ctx_t:                                           \
             _Generic((arg2),                                       \
...
#define shmem_put_nbi(arg1, arg2, ...)                                  \
    _Generic((arg1),                                                    \
             shmem_ctx_t:                                               \
             _Generic((arg2),                                           \
...
#define shmem_get_nbi(arg1, arg2, ...)                                  \
    _Generic((arg1),                                                    \
             shmem_ctx_t:                                               \
             _Generic((arg2),                                           \
...
#define shmem_iget(arg1, arg2, ...)                                     \
    ...
    /* see \ref shmem_long_atomic_swap() */
#define shmem_atomic_swap(arg1, arg2, ...)                              \
    _Generic((arg1),                                                    \
             shmem_ctx_t:                                               \
             _Generic((arg2),                                           \
             ...
             unsigned char *: shmem_uchar_atomic_swap,                  \
             unsigned short *: shmem_ushort_atomic_swap,                \
    ...
    /* see \ref shmem_long_atomic_compare_swap() */
#define shmem_atomic_compare_swap(arg1, arg2, ...)                      \
    _Generic((arg1),                                                    \
             shmem_ctx_t:                                               \
             _Generic((arg2),                                           \
    ...
    /* see \ref shmem_long_atomic_fetch_add() */
#define shmem_atomic_fetch_add(arg1, arg2, ...)                         \
    _Generic((arg1),                                                    \
             shmem_ctx_t:                                               \
             _Generic((arg2),                                           \
    ...
    /* see \ref shmem_long_atomic_fetch_inc() */
#define shmem_atomic_fetch_inc(arg1, arg2, ...)                         \
    _Generic((arg1),                                                    \
             shmem_ctx_t:                                               \
             _Generic((arg2),                                           \
...
#define shmem_atomic_fetch_and(arg1, arg2, ...)                         \
    _Generic((arg1),                                                    \
             shmem_ctx_t:                                               \
             _Generic((arg2),                                           \
...
#define shmem_atomic_fetch_or(arg1, arg2, ...)                          \
    _Generic((arg1),                                                    \
             shmem_ctx_t:                                               \
             _Generic((arg2),                                           \
...
#define shmem_atomic_fetch_xor(arg1, arg2, ...)                         \
    _Generic((arg1),                                                    \
             shmem_ctx_t:                                               \
             _Generic((arg2),                                           \
    ...
    /* see \ref shmem_long_atomic_add() */
#define shmem_atomic_add(arg1, arg2, ...)                               \
    _Generic((arg1),                                                    \
             shmem_ctx_t:                                               \
             _Generic((arg2),                                           \
    ...
    /* see \ref shmem_long_atomic_inc() */
#define shmem_atomic_inc(arg1, arg2, ...)                               \
    _Generic((arg1),                                                    \
             shmem_ctx_t:                                               \
             _Generic((arg2),                                           \
...
#define shmem_atomic_and(arg1, arg2, ...)                               \
    _Generic((arg1),                                                    \
             shmem_ctx_t:                                               \
             _Generic((arg2),                                           \
...
#define shmem_atomic_or(arg1, arg2, ...)                                \
    _Generic((arg1),                                                    \
             shmem_ctx_t:                                               \
             _Generic((arg2),                                           \
...
#define shmem_atomic_xor(arg1, arg2, ...)                               \
    _Generic((arg1),                                                    \
             shmem_ctx_t:                                               \
             _Generic((arg2),                                           \
...
#define shmem_test(ivar, cmp, cmp_value)                \
    _Generic((ivar),                                    \
